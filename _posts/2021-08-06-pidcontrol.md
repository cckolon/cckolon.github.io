...
keywords: PID control, Unity, game development, submarines, physics simulation, control theory, C#
---
...
![Hunting in proportional control](/assets/media/pinstability.gif){: width="600" height="317"}
...
![Damped Instability](/assets/media/subinstability.gif){: width="600" height="317"}
...
![Offset](/assets/media/suboffset.gif){: width="600" height="318"}
...
![PID Control](/assets/media/stablepid.gif){: width="600" height="337"}
...
![Tennis Racket Theorem](/assets/media/tennisracket.gif){: width="854" height="480"}
...
![Nirvana](/assets/media/nirvana.gif){: width="600" height="336"}