...
image: /assets/media/watchbill/worstdeal.webp
image_width: 476
image_height: 186
...
![Blank Watchbill](/assets/media/watchbill/blank.webp){: width="354" height="249"}

We can assign our vector \\(\mathbf{x} = \left(x_{a1},x_{a2},\ldots\right)\\), where each \\(x\\) is a zero (not assigned) or a one (assigned).

![Watchbill Variables](/assets/media/watchbill/variables.webp){: width="354" height="249"}

Suppose that we assign each element of \\(\mathbf{x}\\) randomly. We might get something like this:

![Random Assignments](/assets/media/watchbill/random.webp){: width="354" height="249"}
...
![A basic schedule](/assets/media/watchbill/basicsolution.webp){: width="354" height="249"}
...
![Conflict Matrix](/assets/media/watchbill/conflictmatrix.webp){: width="354" height="249"}
...
![Solution With Conflicts](/assets/media/watchbill/solutionwconflicts.webp){: width="354" height="249"}
...
![Fairer Solution](/assets/media/watchbill/fairersolution.webp){: width="354" height="249"}
...
<div class = "outer">
<div class = "block"><img width="406" height="343" style = "padding: 50px 50px 50px 50px center-image" src="/assets/media/watchbill/badness1.webp" alt="First Schedule" /></div> <div class = "block"><img width="393" height="343" style = "padding: 50px 50px 50px 50px center-image" src="/assets/media/watchbill/badness2.webp" alt="Second Schedule" /></div>
</div>
...
![Minimizing the worst deal](/assets/media/watchbill/worstdeal.webp){: width="476" height="186"}
...
![The problem with selecting according to worst_deal](/assets/media/watchbill/worstdealproblem.webp){: width="476" height="175"}
...
![The problem with deal_spread](/assets/media/watchbill/dealspreadproblem.webp){: width="476" height="195"}
